 ...
 */
class KurobaHttpLoggingInterceptor @JvmOverloads constructor(
...
//        val directory = File(context.filesDir, "requests")
//        if (!directory.exists()) {
//            directory.mkdirs()
//        }
//
...
//                    file.appendBytes(buffer2.readByteArray())
//                }
    ...
    private fun logHeader(headers: Headers, i: Int, file: File) {
